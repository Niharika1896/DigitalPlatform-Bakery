					...
					<div class="col-md-8" align="center">
						<div class="card bg-light mb-2">
							<div class="card-header" style="background-color: #F8D6FE;">
								<h3 class="text-left"><i>Billing Address</i></h3>
							</div>
							<div class="card-body text-left" style="background-color: #F8DFFC;">
								<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="orderbynameform">
									<div class="form-row">
										...
										<div class="form-group col-md-3">
											<label for="Search">Check if customer exists</label>
											...
											if($result) {
												if($nrow == 1) {
													...
													while($row = mysqli_fetch_array($result)) {
														$ordered_by_cid = $row['customer_ID'];
														$ordered_by_cname = $row['name'];
													}

													echo "<h5 class='text-left'><i>". strtoupper($ordered_by_cname) . "</i></h5></br>";

													echo "<h3 class='text-right'><b><a href=\"neworder_delto.php?ordered_by_cid=$ordered_by_cid\" target=\"_self\"><i>>>NEXT</i></a></b></h3></br>";
