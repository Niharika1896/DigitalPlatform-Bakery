					...
					<div class="col-md-12" align="center">
						<div class="card bg-light mb-2">
							...
							<div class="card-body text-left" style="background-color: #F8DFFC;">
								<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											<label for="prodqty">Shipping Customer Details</label>
											<select id="prodqty" name="prodqty" class="form-control">
												...
												<?php
													...
													$sql = "SELECT distinct concat(name,'-',phone1) VAL, name, phone1 FROM customer_master inner join order_for on customer_master.customer_ID = order_for.shipping_customer order by name";
                              ...
                              $name= $row['name'];
                              $phone1 = $row['phone1'];
                              $cid = strtoupper(substr($name,0,3)) . $phone1;

															echo "<option value='".$cid."'>".$concatname."</option>";
														}
										...
										<div class="form-group col-md-6">
											<label for="produom">Delivery Date</label>
